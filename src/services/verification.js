...
export class VerificationSystem {
  static createVerificationEmbed() {
    ...
    const welcomeText = [
      ...
      '\u001b[1;35m' + centerText('≽^•⩊•^≼') + '\u001b[0m',
      '',
      '\u001b[1;34m' + centerText('💫 For BP Players') + '\u001b[0m',
      '',
      '\u001b[1;37m' + centerText('Register your character &') + '\u001b[0m',
      '\u001b[1;37m' + centerText('unlock the full server! ♡') + '\u001b[0m',
      '',
      '\u001b[1;34m' + centerText('🌸 Just Vibing?') + '\u001b[0m',
      '',
      '\u001b[1;37m' + centerText('Get basic access to chat!') + '\u001b[0m',
      '\u001b[1;37m' + centerText('No character needed ^_^') + '\u001b[0m',
      '',
      '\u001b[35m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\u001b[0m'
    ].join('\n');
